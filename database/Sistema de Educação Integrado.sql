...
INSERT INTO `Aluno` (`nome`, `dataNascimento`, `nomeMae`, `nomePai`, `rg`, `cpf`, `naturalidade`, `endereco`, `telefone`, `sexo`, `senha`, `nlogin`) VALUES
	('João Guedes de Moura Junior', '2002-05-15', 'Maria da Penha', 'João Guedes', '111.222.333', '111.111.111-11', 'Nova Cruz', 'Rua Antônio Viana Barbosa 104', '(84) 99478-6496', 'Masculino', '$argon2i$v=19$m=65536,t=4,p=1$RDA4TmtIWi5FaHJUL0hDVQ$wMu6sixHUo7YsN9lgL+o/5+b04JDrsf+mdgUjKHa/zQ', 0),
...
INSERT INTO `Responsavel` (`idAluno`, `cpf`, `rg`, `telefone`, `email`, `nome`, `senha`, `nlogin`) VALUES 
	(1, '111.111.111-00', '111.111.000', '(84) 99999-9999', 'joaoguedes@outlook.com', 'João Guedes', '$argon2i$v=19$m=65536,t=4,p=1$UThoMjlzT1NhU0E3RW1IaA$fMqlWEMnOeUMd+dvmNnnoGDT3xoprVzhD/xR/T3VC6I', 0),
	...
	(9, '999.999.999-00', '999.999.000', '(84) 98096-5793', 'fernandodiogo@gmail.com', 'Fernando Diogo Renato Baptista', '$argon2i$v=19$m=65536,t=4,p=1$MWw3REpyNEIubmNoaGFkSA$mDKzJpjMv4GO7dYA68J3bAhjgW1pISuyMwPVkuISAag'),
	(10, '101.101.101-00', '101.101.000', '(84) 98765-6422', 'beneditoenzo@outlook.com', 'Benedito Enzo Caleb Baptista', '$argon2i$v=19$m=65536,t=4,p=1$QVVUYVFscy9tWVFpdXNHVg$04FPxTTVvA12XgQEKtIRJWa22kbGM2JVwUQMiWqnUQw'),
	(11, '110.110.110-00', '110.110.000', '(84) 98765-0743', 'anthonydiego@gmail.com', 'Anthony Diego Luan Vieira', '$argon2i$v=19$m=65536,t=4,p=1$NHpBTHJFWXZDVFRBSXluYw$fIcT2APoGtlmkgs2IP6hjSSAh9UNbkQ2pudRSnaHbH4'),
	(12, '120.120.120-00', '120.120.000', '(84) 99465-5467', 'juanvictor@live.com', 'Juan Victor Fernando Peixoto', '$argon2i$v=19$m=65536,t=4,p=1$QlFsL0dKVXdKYWVqeHNOdA$awY9rS08bcJHRuLIsdkBGT5NOcCh2vSCjBPnl87z5aI'),
	(13, '130.130.130-00', '130.130.000', '(84) 99306-9573', 'osvaldodavi@hotmail.com', 'Osvaldo Davi Rodrigues', '$argon2i$v=19$m=65536,t=4,p=1$ZmNJRXF4eGRMM3N2RnY4eA$mwyT/MlLQxHO0HUUUeSPRTD19sOJ2Z2cCJ7Bmn2OgO0'),
	(14, '140.140.140-00', '140.140.000', '(84) 99785-7859', 'paulotheo@live.com', 'Paulo Theo Luís dos Santos', '$argon2i$v=19$m=65536,t=4,p=1$dmd1bjFqQmMvRlp0T0hGMA$rHsG856gCqM6afoFU9kCOVM+zuHTDpe2Z0TTJuHzUBE'),
	(15, '150.150.150-00', '150.150.000', '(84) 99673-0909', 'bernardolucca@gmail.com', 'Bernardo Lucca Barbosa', '$argon2i$v=19$m=65536,t=4,p=1$NXU4QU9wUWNYQ2dIc0kvTg$L3fChIwXp0f7R/DNeROCHEWExHDre5MDnkL34COhgUo'),
	(16, '160.160.160-00', '160.160.000', '(84) 98904-5626', 'cauamanuel@outlook.com', 'Cauã Manuel Kaique de Paula', '$argon2i$v=19$m=65536,t=4,p=1$U3IxVkswdTdCVzJqZVVwaQ$WpWtt+3hFCvwV3c2+Qyud7y8YT5FYafg3e8bePwc2z0'),
	(17, '170.170.170-00', '170.170.000', '(84) 98594-6078', 'kevincarlos@gmail.com', 'Kevin Carlos Eduardo Rodrigues', '$argon2i$v=19$m=65536,t=4,p=1$MWN6VmVUUHhRU0VPVmhUeA$Guaq05C2KzAyzeoAVJNnmsGIOrq3MHYwCvmoRYuDAPg'),
	(18, '180.180.180-00', '180.180.000', '(84) 99345-0962', 'oliversergio@yahoo.com.br', 'Oliver Sérgio Manuel Carvalho', '$argon2i$v=19$m=65536,t=4,p=1$VEZZNzBRSHBBSDJOU0RpaA$HPh9tFqA//J0hOS7TFIY1F/7Qzvt1I2Blc5MJcwl7/M'),
	(19, '190.190.190-00', '190.190.000', '(84) 99349-9679', 'rodrigoruan@bol.com', 'Rodrigo Ruan Moreira', '$argon2i$v=19$m=65536,t=4,p=1$Y2R3aE5YWC96U3R1ODFtaQ$+7WTdh3djkNVOSWRMQiNNC1GKmQAzh/1Gr6vnhCiPFU'),
	(20, '200.200.200-00', '200.200.000', '(84) 99563-7854', 'marcosvinicius@gmail.com', 'Marcos Vinicius Mário Sérgio Moraes', '$argon2i$v=19$m=65536,t=4,p=1$VElZTHFjNGFmL09VSG9vMA$ck1Weu2FoiRk6zK+9uNRVW0hIc2cw/2B3u9f12OrjBA');

INSERT INTO `Funcionario` (`nome`, `cpf`, `email`, `telefone`, `dataNascimento`, `cargo`, `senha`) VALUES 
	('João Guedes de Moura Junior', '123.111.111-00', 'joaodocente@gmail.com', '(84) 99494-9494', '1995-05-12', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$U2p5ZVprc1JGeTRLNEV2bg$oT8t5biZsQN/Z9yx2WgIG5nhM9K/R3kdKX7WbnukzDA'),
	('Matias Justino', '123.222.222-00', 'matiasdocente@gmail.com', '(84) 99494-563', '1998-04-22', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$a05DZmxpWUZIdWNQbm1VVg$TvxXP9LbE7UHByK2PPEdbsm9tYo+DOK3pNftR9/cdCA'),
	('Maria da Penha Justino de Moura', '123.333.333-00', 'mariadocente@gmail.com', '(84) 99494-3578', '1991-10-02', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$UWgzYUtQeFlwaG1qcS4yVA$xep01t3FsecUaSDIUyjElF3jVG9XqKmKYY90kdZHMGM'),
	('Bruna Guedes de Moura', '123.444.444-00', 'brunadocente@gmail.com', '(84) 99494-7676', '1997-05-10', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$V2JZZHkzMVMxMFBIVEd5dg$l0tNs/riGlOt2Ixu1LIkJ2q/2uWqGLKLUsOtMg6z1dw'),
	('Eliane Padilha dos Santos Moura', '123.555.555-00', 'elianedocente@gmail.com', '(84) 99494-5376', '1998-12-02', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$V1dicTh5Ri9BbHZCLkdQVg$xFijUI+qP2zKbRvki0rFyRnhAdirxicfBfKbZRT360M'),
	('Edieluza Ernesto da Silva', '123.666.666-00', 'edileuzadocente@gmail.com', '(84) 99494-9866', '1995-04-12', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$UERNbGFzZC40ZTZGZkFxQw$HsKl1aCGuyiHdCOwgAqU/Al/dt0Vldz8XZZDLeCdIZk'),
	('Carlos Andre de Freitas', '123.777.777-00', 'carlosdocente@gmail.com', '(84) 99494-9494', '1997-05-12', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$SVNLWmUvcFpnYklqbkdOVA$dIpXzzIFGZ6ox3RV2c/3tXrDID9d0HWSzdnjEoF4TCg'),
	('Marcio Oliveira da Silva', '123.888.888-00', 'marciosecretario@gmail.com', '(84) 99094-9494', '1997-02-08', 'Secretario', '$argon2i$v=19$m=65536,t=4,p=1$QTBKZ3dYaHF2a0FaZEhYRQ$aXgT1LJLOAUT7Z4EAmilI+lT+hybgZ2CXnJwWmudd+U'),
	('Geraldo de Souza', '123.999.999-00', 'geraldodocente@gmail.com', '(84) 99494-0000', '1995-08-19', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$NEViWnlPZVp3UUpnWVVSaw$y/eaNmxQI4sYMR6ASzyZmuRIQUIb7q60tcBcw3uIi1A'),
	('Fernando Conceição Marques', '123.101.101-00', 'fernandodocente@gmail.com', '(84) 99494-9000', '1995-07-29', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$N05RejRDY1NWdUR4cmJndw$uinIVr1mPNsJPnN3+i2xNW97SF8ulZQ/1w6P8fNZBgw'),
	('Elizabeth Cavalcante de Souza', '123.110.110-00', 'elizabethdocente@gmail.com', '(84) 99494-9004', '1994-09-07', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$emV1Y0hody5jUXlJSzJmdA$RVFR9ZUnA73NoYyYR/pupEzfUoaS/Mc/F4jmdbHViUc'),
	('Maria Educarda da Conceição', '123.120.120-00', 'mariasecretaria@gmail.com', '(84) 99494-4940', '1992-04-14', 'Secretario', '$argon2i$v=19$m=65536,t=4,p=1$LzdmQjZUR080MEI3Wjd6Rg$3zmOdbSCCnGa0Dbr6jd2tUy4eKJfcQGi8ejZl3JNlUE'),
	('Ednaldo Fernandes de Souza', '123.130.130-00', 'ednaldodocente@gmail.com', '(84) 99494-9794', '1990-09-21', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$c0xvQUdMNkQ0d2toay4vMw$Kwd5K/2p925tZsGQXb+8iSLvJi4xxrzYhRBOkOl6I/8'),
	('Manoel Cerafim da Costa', '123.140.140-00', 'manoeldocente@gmail.com', '(84) 99494-8894', '1995-05-27', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$Z3Raemo2bDdZbllIQ25FTQ$wuCzkdDhItwS2UIcN7W0khfjcc7APvxKgQwUrxvai44'),
	('José Alcantara Furtado', '123.150.150-00', 'josedocente@gmail.com', '(84) 99494-9784', '1990-04-17', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$ZzQ3VWN4YTJKZDE4WHEvaA$4mYuyVeITEx39qcqECo6NUOIK9PkQ9mo9zIsyyJwT3s'),
	('André Gomes', '123.160.160-00', 'andredocente@gmail.com', '(84) 99494-9657', '1999-10-18', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$NEp2N2FkWEIzQ3BSRXZ1bw$K8az8gmB/QWWyv8LcezLVk59uxnBiHGueKKFhC78BFc'),
	('João Carlos Guedes', '123.170.170-00', 'joaosecretario@gmail.com', '(84) 99784-0883', '1993-05-20', 'Secretario', '$argon2i$v=19$m=65536,t=4,p=1$c1NjeU5pc3o5aGxoZzBYZw$9werFIVZrV+X+1J/Jik/EAoWZzqhJNBaUAccwdsTlew'),
	('Vivian Trajano da Silva', '123.180.180-00', 'viviandocente@gmail.com', '(84) 98494-9890', '1994-01-02', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$MldKaDJoSC9hM3JORnNWNg$l/6nxCXHeaSFzukaQugt5GgBzvRNFeKi3PeX8LnUnT4'),
	('Maria Clara da Silva', '123.190.190-00', 'claradocente@gmail.com', '(84) 99432-8494', '1997-05-12', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$WFE0b1RWeXNzbFF6RGdpaw$A60WukGZu9WJI1S4zLSjlCwCcfEIs7++Hvffk0iL++Q'),
	('Otávio Mendonça Silva', '123.200.200-00', 'otaviodocente@gmail.com', '(84) 99976-9854', '1996-06-25', 'Professor', '$argon2i$v=19$m=65536,t=4,p=1$WE1iUFNOTHlvN3JuRGpxTw$GEjxZyXUF3Z1oTYONcMJc5sLoZVK1551NWn7b9F8krY');
...
INSERT INTO `DisciplinaTurma` (`idDisciplina`, `idAluno`, `idTurma`, `1b`, `2b`, `3b`, `4b`) VALUES 
