...
<body>
    <div style="margin-top: 10%;">
        ...
        <button class="btn btn-info btn-md border-0 btn-block btn-lg" data-toggle="modal" data-target="#myModal3" style="background-color: #33a583"><i class="fas fa-plus-circle"></i> Cadastrar Disciplina</span></button>
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" action="/cadastrar-disciplina" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Nome da disciplina " name="nome" value="<?= $dis->nome ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
